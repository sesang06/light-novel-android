...
import kotlinx.android.synthetic.main.item_light_novel_featured_info.view.*

class LightNovelFeaturedInfoViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
