...
import kotlinx.android.synthetic.main.item_light_novel_recommend.view.*


class LightNovelRecommendViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
